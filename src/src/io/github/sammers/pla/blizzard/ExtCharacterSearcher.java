...
public class ExtCharacterSearcher {
  ...
  // -H 'dnt: 1' \
  // -H 'function:
  // U2FsdGVkX1+Rl92103/E7/dkzHxy7sLOxAbJs5Y0bWMfxdE0y5vh64+erBHdvSfykmNDMIYzvercAJa/4z8dW9u8qLh0R1qcso9WJCqim4U='
  // \
  // -H 'priority: u=1, i' \
  // -H 'referer: https://check-pvp.fr/' \
  // -H 'sec-ch-ua: "Not/A)Brand";v="8", "Chromium";v="126", "Google
  // Chrome";v="126"' \
  ...
  // curl 'https://check-pvp.fr/api/characters/search?s=Minpog&region=eu' -H
  // 'accept:
  // application/json, text/plain, */*' -H 'accept-language:
  // ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7,be;q=0.6' -H 'authorization: Bearer null'
  // -H
  // 'content-type: application/json' -H 'cookie: language=en; defaultRegion=eu;
  // reducePatreon=true' -H 'delay: -319' -H 'dnt: 1' -H 'function:
  // U2FsdGVkX1+Rl92103/E7/dkzHxy7sLOxAbJs5Y0bWMfxdE0y5vh64+erBHdvSfykmNDMIYzvercAJa/4z8dW9u8qLh0R1qcso9WJCqim4U='
  // -H 'priority: u=1, i' -H 'referer: https://check-pvp.fr/' -H 'sec-ch-ua:
  // "Not/A)Brand";v="8", "Chromium";v="126", "Google Chrome";v="126"' -H
  // 'sec-ch-ua-mobile: ?0' -H 'sec-ch-ua-platform: "Windows"' -H 'sec-fetch-dest:
  // empty' -H 'sec-fetch-mode: cors' -H 'sec-fetch-site: same-origin' -H
  ...
  // "delay": "-320",
  // "function":
  // "U2FsdGVkX18CMjQEe0VRFkbsNFt+hvyDhQwFvxyNjN3GNo4yazbmfcuE0Wbmv+iW89CZixqujVTuyRM46DJwh2oakfFvZIgcWycSp/XGO9s=",
  // "priority": "u=1, i",
  ...
  // });
  //
  // [{"name":"Minpog","realm":"Aegwynn","region":"eu","class":null},{"name":"Minpog","realm":"Aerie
  // Peak","region":"eu","class":null},{"name":"Minpog","realm":"Agamaggan","region":"eu","class":null},{"name":"Minpog","realm":"Aegwynn","region":"us","class":null},{"name":"Minpog","realm":"Aerie
  // Peak","region":"us","class":null},{"name":"Minpog","realm":"Alexstrasza","region":"kr","class":null},{"name":"Minpog","realm":"Azshara","region":"kr","class":null},{"name":"Minpog","realm":"Arthas","region":"tw","class":null},{"name":"Minpog","realm":"Arygos","region":"tw","class":null}]
  public Single<List<ExtSearchResult>> searchChars(String query) {
    return webClient.getAbs("https://check-pvp.fr/api/characters/search")
      ...
      .putHeader("delay", "-320")
      .putHeader("function",
        "U2FsdGVkX189BJAAw+cWbtGA3nGSmDd2NYQ4QreYqVh7aeOqrJJZFMxqg9y/FQX2kDym02VmprcIn5OW18nMa1EaM0Gv+rduUUYMI8TYarQ=")
  ...
  // Example:
  // https://worldofwarcraft.blizzard.com/en-gb/search/character?q=sammers
  public Single<List<ExtSearchResult>> searchCharacterOfficial(String name) {
    return webClient.getAbs("https://worldofwarcraft.blizzard.com/en-gb/search/character")
      ...
      .flatMap(response -> {
        ...
        List<ExtSearchResult> res = results.stream().map(ExtSearchResult::fromOfficialArmory).toList();
  ...
  public record ExtSearchResult(String name, String realm, String region, String clazz) implements JsonConvertable {
    public SearchResult toSearchResult() {
      return new SearchResult(String.format("%s-%s", name, realm), region, clazz, null, null, null, null, null, null,
        null);
    }
    ...
    public static ExtSearchResult fromOfficialArmory(Element element) {
      ...
      return new ExtSearchResult(name, realm, "eu", clazz);
    }

    public static ExtSearchResult fromJson(io.vertx.core.json.JsonObject json) {
      return new ExtSearchResult(json.getString("name"), json.getString("realm"), json.getString("region"),
        json.getString("class"));
    }

    @Override
    public JsonObject toJson() {
      return new JsonObject().put("nick", String.format("%s-%s", name, realm))
        .put("region", region)
        .put("class", clazz);
    }
  }
